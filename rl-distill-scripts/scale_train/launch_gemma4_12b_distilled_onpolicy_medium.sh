...
ENV_VARS+=",ENABLE_OVERLONG_BUFFER=False,GEN_TP=1,HF_PUSH_FREQ=${SAVE_FREQ},HF_PUSH_MAX_TO_KEEP=24,LOG_TRAIN_GENERATIONS=100,LOG_VAL_GENERATIONS=100,MAX_ACTOR_CKPT_TO_KEEP=2,MAX_MODEL_LEN=12288,MAX_PROMPT_LENGTH=4096,MAX_RESPONSE_LENGTH=8192,OFFLOAD=False"
...
ENV_VARS+=",FSDP_CPU_OFFLOAD_POLICY=True,MAX_PADDED_TOKENS_PER_MICROBATCH=4096,MICRO_BATCH_SIZE_PER_GPU=1,ROLLOUT_GPU_MEMORY_UTILIZATION=${ROLLOUT_GPU_MEMORY_UTILIZATION:-0.35},VERL_SKIP_VLLM_MM_WEIGHT_RELOAD=1,VLLM_KV_CACHE_MEMORY_BYTES=${VLLM_KV_CACHE_MEMORY_BYTES:-4294967296}"
