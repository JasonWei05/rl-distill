...
export MAX_ACTOR_CKPT_TO_KEEP="${MAX_ACTOR_CKPT_TO_KEEP:-1}" MAX_MODEL_LEN=12288   # /tmp is a shared, nearly full volume: keep one local checkpoint (S3 has the history) MAX_PROMPT_LENGTH=4096 MAX_RESPONSE_LENGTH=8192
