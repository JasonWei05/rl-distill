...
"""Build a 16.5k subset of nvidia/Nemotron-Cascade-2-SFT-Data and push to HF.
...
the combined 16.5k into 16k train / 500 validation and pushes to a public repo.
...
TARGET_REPO = "JWei05/Nemotron-Cascade-2-SFT-Data-16k-subset"
SUBSETS = ["chat", "instruction_following", "science"]
TOKENIZER_NAME = "google/gemma-3-4b-it"

POOL_SIZE = 20_000
PICK_PER_SUBSET = 5_500
TRAIN_SIZE = 16_000
