...
# B200 single-node defaults for continuing DAPO RL from the TopK128-distilled
# Gemma 3 12B checkpoint. This script assumes the model and DAPO split have
# already been prepared locally; override MODEL_PATH/TRAIN_FILE/VAL_FILES if
# using shared storage or another node layout.
...
project_name='DAPO'
exp_name=${EXP_NAME:-"DAPO-Gemma3-12B-B200-1Node-DAPO17k-20kResp-$(date +%Y%m%d-%H%M)"}
