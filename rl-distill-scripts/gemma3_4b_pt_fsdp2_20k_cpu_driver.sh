...
export MODEL_PATH=${MODEL_PATH:-"/tmp/hf_models/gemma-3-4b-pt"}
export EXP_NAME=${EXP_NAME:-"DAPO-Gemma3-4B-PT-FSDP2-$(date +%Y%m%d-%H%M)"}
export HF_PUSH_REPO=${HF_PUSH_REPO:-"JWei05/dapo-gemma3-4b-pt"}
