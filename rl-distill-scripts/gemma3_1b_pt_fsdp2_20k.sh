...
project_name='DAPO'
exp_name=${EXP_NAME:-"DAPO-Gemma3-1B-PT-$(date +%Y%m%d-%H%M)"}
...
MODEL_PATH=${MODEL_PATH:-"${RAY_DATA_HOME}/models/gemma-3-1b-pt"}
CKPTS_DIR=${CKPTS_DIR:-"/tmp/verl/ckpts/${project_name}/${exp_name}"}
HF_PUSH_REPO=${HF_PUSH_REPO:-"JWei05/dapo-gemma3-1b-pt"}
