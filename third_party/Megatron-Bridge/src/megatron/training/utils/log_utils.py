...
try:
    ...
    from megatron.bridge.utils.common_utils import get_rank_safe as safe_get_rank
    from megatron.bridge.utils.common_utils import get_world_size_safe as safe_get_world_size
