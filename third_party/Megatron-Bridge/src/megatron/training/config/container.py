...
except ImportError:  # vendored subset without megatron.training.models
    from megatron.bridge._mlm_compat.models_base import Serializable

    GPTModelConfig = object
    HybridModelConfig = object
