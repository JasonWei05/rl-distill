# Vendored from NVIDIA/Megatron-LM@64c3fb86ca2b1b875c0206500195b4de2977592a (megatron/training/*)
# for compatibility with megatron-core pip installs (e.g. core_v0.16.0) that do not
# ship the megatron.training package.
    ...
    *,
    ...
    with torch.cuda.stream(ddp_stream):
        ...
        for model_chunk_idx, model_chunk in enumerate(model):
            ...
            # Older megatron-core (e.g. core_v0.16.0) computes the layout inside
            # the optimizer and DDP does not accept full_param_layout.
            if (
                ddp_config.use_distributed_optimizer
                and DP is DistributedDataParallel
                and hasattr(DistributedOptimizer, "compute_full_param_layout")
            ):
                all_params = [
