...
# megatron.core._slurm_utils only exists in newer Megatron-LM; fall back to
# env-based helpers on megatron-core pip installs (e.g. core_v0.16.0).
try:
