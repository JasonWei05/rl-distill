...
# Mamba requires Megatron-LM APIs newer than megatron-core pip installs
# (e.g. core_v0.16.0); degrade to stubs so config typing keeps working.
try:
    from megatron.bridge.models.mamba.mamba_builder import MambaModelConfig
    from megatron.bridge.models.mamba.mamba_provider import MambaModelProvider
except ImportError:  # pragma: no cover
    MambaModelConfig = type("MambaModelConfig", (), {})
    MambaModelProvider = type("MambaModelProvider", (), {})
try:
    from megatron.bridge.models.megatron_mimo.megatron_mimo_provider import MegatronMIMOProvider
except ImportError:  # requires newer megatron-core than the installed pip build
    MegatronMIMOProvider = type("MegatronMIMOProvider", (), {})
