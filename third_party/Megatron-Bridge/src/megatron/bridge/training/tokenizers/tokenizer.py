...
except ImportError:  # megatron-core pip installs (e.g. core_v0.16.0)

    def build_mcore_tokenizer(config, **kwargs):
        raise NotImplementedError(
            "megatron.core.tokenizers.utils.build_tokenizer is unavailable in this megatron-core; "
            "Megatron tokenizer building is not supported here"
        )
